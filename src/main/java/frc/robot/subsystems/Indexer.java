...
public class Indexer extends SubsystemBase {
  ...
  public final void setTargetVelocity(final double pos) {
  ...
  public final void setVelocityControl(final double vel) {
    topIndexerMotor.setVelocityControl(vel);
    bottomIndexerMotor.setVelocityControl(vel);
  }

  public final void setEnabled(final boolean bol) {
    this.enabled = bol;
  }
  ...
  public final void runPIDPosition() {
  ...
  public final boolean hasReachedPosition(final double position) {
    return Math.abs(getTopPosition() - position) < IndexerConstants.kAllowedError;
  }

  // Setpoints

  public final Command intakeOneNoteCommand() {
    return Commands.runOnce(() -> intakeOneNote());
  }

  public final void intakeOneNote() {
