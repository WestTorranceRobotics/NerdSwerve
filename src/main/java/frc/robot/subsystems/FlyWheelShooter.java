...
public class FlyWheelShooter extends SubsystemBase {
  ...
  public FlyWheelShooter() {
    ...
    bottomMotor.configurePIDF(FlywheelConstants.kP, FlywheelConstants.kI, FlywheelConstants.kD, FlywheelConstants.kIz,
        FlywheelConstants.kF, FlywheelConstants.kMinOutput, FlywheelConstants.kMaxOutput);

    topMotor.configureMotor(FlywheelConstants.kRotorToSensorRatio,
        FlywheelConstants.kOpenLoopRampRate,
        FlywheelConstants.kControlFramePeriod, FlywheelConstants.kEncoderControlFramePeriod,
        FlywheelConstants.kInverted, FlywheelConstants.kIdleBrake);
    topMotor.configurePIDF(
        FlywheelConstants.kP,
        FlywheelConstants.kI,
        FlywheelConstants.kD,
        FlywheelConstants.kIz,
        FlywheelConstants.kF,
        FlywheelConstants.kMinOutput,
        FlywheelConstants.kMaxOutput);

  }

  public final void resetEncoder(final double pos) {
  ...
  public final void setTargetVelocity(final double vel) {
    this.targetVelocity = vel;

  }

  public final double getTopVelocity() {
    return topMotor.getVelocity();
  }

  public final double getBottomVelocity() {
  ...
  public final boolean hasReachedVelocity(final double velocity) {
    return Math.abs(getVelocity() - velocity) < FlywheelConstants.kAllowedError;
  }
  ...
  public final double getTopAppliedVoltage() {
    return topMotor.getMotorVoltage();
  }

  public final double getBottomAppliedVoltage() {
  ...
  public final double getCurrentErrorPercentage() {
    return (getTargetVelocity() - getVelocity()) / (getTargetVelocity());
  }

  public final void incrementVelocity(final double increment) {
    setTargetVelocity(getTargetVelocity() + increment);
  }

  public final Command incrementVelocityCommand(final double increment) {
  ...
  public final Command speedToNeutralCommand() {
  ...
  // ****************************** MANUAL METHODS
  // ******************************//
  public final void setPercentageTop(final double per) {
    topMotor.setSpeed(per);
  }

  public final void setPercentageBottom(final double per) {
  ...
  public final void setVelocityShuffleBoard() {
