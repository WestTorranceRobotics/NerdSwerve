...
public class SwerveDriveTrain extends SubsystemBase {
    ...
    private final StructPublisher<ChassisSpeeds> chassisSpeedPublisher = NetworkTableInstance.getDefault()
            .getStructTopic("ChassisSpeed", ChassisSpeeds.struct).publish();

    private final DoublePublisher rotationPublisher = NetworkTableInstance.getDefault().getDoubleTopic("Rotation")
            .publish();
    ...
    public final void refreshModulePID(final double kPDrive, final double kIDrive, final double kDDrive,
            final double kVDrive, final double kPTurning,
            final double kITurning, final double kDTurning) {
    ...
    /**
     * Have modules move to their desired states. See {@link SwerveModule#run()} for
     * more info.
     */
    ...
    public final void driveFieldOriented(final double xSpeed, final double ySpeed, final double turnSpeed) {
        setModuleStates(
                SwerveDriveConstants.kDriveKinematics.toSwerveModuleStates(
