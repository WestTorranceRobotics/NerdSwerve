...
public class Arm extends SubsystemBase {
  ...
  public Arm() {
    ...
    // double kMaxVelocity, double kMinVelocity, double kMaxAccel, double
    // kAllowedError ){

    armLeftMotor = new CanController(ArmConstants.kLeftArmMotorID);
    armLeftMotor.configureMotor(ArmConstants.kRotorToSensorRatio, ArmConstants.kOpenLoopRampRate,
        ArmConstants.kControlFramePeriod, ArmConstants.kEncoderControlFramePeriod, ArmConstants.kLeftInverted,
        ArmConstants.kIdleBrake);
    armLeftMotor.configurePIDF(ArmConstants.kP, ArmConstants.kI, ArmConstants.kD, ArmConstants.kIz, ArmConstants.kF,
        ArmConstants.kMinOutput, ArmConstants.kMaxOutput);
    ;
    armLeftMotor.configureSmartMotion(ArmConstants.kMaxVelocity, ArmConstants.kMinVelocity, ArmConstants.kMaxAccel,
        ArmConstants.kAllowedError);

    armRightMotor = new CanController(ArmConstants.kRightArmMotorID);
    armRightMotor.configureMotor(ArmConstants.kRotorToSensorRatio, ArmConstants.kOpenLoopRampRate,
        ArmConstants.kControlFramePeriod, ArmConstants.kEncoderControlFramePeriod, ArmConstants.kRightInverted,
        ArmConstants.kIdleBrake);
    armRightMotor.configurePIDF(ArmConstants.kP, ArmConstants.kI, ArmConstants.kD, ArmConstants.kIz, ArmConstants.kF,
        ArmConstants.kMinOutput, ArmConstants.kMaxOutput);
    armRightMotor.configureSmartMotion(ArmConstants.kMaxVelocity, ArmConstants.kMinVelocity, ArmConstants.kMaxAccel,
        ArmConstants.kAllowedError);
  ...
  /**
   * Command wrapper moving arm to {@link ArmConstants#kNeutralPosition}.
   * 
   * @return A command calling {@link #moveToNeutral()} once.
   */
  ...
  /**
   * Moves arm to {@link ArmConstants#kNeutralPosition}.
   */
  ...
  /**
   * Moves arm to {@link ArmConstants#kGroundIntakePosition}.
   */
  ...
  /**
   * Moves arm to {@link ArmConstants#kShooterFeedingPosition}.
   */
